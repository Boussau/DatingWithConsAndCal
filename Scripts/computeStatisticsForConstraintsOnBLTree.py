...
id2Height = getMedianNodeDepths( t )

nodeId2LeafListRef, leafList2NodeIdRef, idToDescendants = getNameToLeavesAndIdToDescendantIdsLink( t )

with open(out_file, "w") as fout:
    fout.write("older_left\tolder_right\tyounger_left\tyounger_right\to_depth\ty_depth\tdelta_depth\tdelta_nodes\tdelta_dist\tacross_the_root\tnum_leaves_older\tnum_leaves_younger\tnum_ancestors_older\tnum_ancestors_younger\n")
