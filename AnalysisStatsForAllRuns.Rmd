...
Renaming balanced or not
```{r}
levels(d$balanced)[levels(d$balanced)=="n"] <- "unbalanced"
levels(d$balanced)[levels(d$balanced)=="y"] <- "balanced"
```
...
colScale <- scale_colour_manual(name = "Calibrations",values = myColors)
