...
#in Mb per CPU
# program to launch
PROGRAMS=("bash unbalancedNoConstraint.sh" "bash unbalanced1Constraint.sh" "bash unbalanced5Constraint.sh" "bash unbalanced10Constraint.sh" "bash unbalanced15Constraint.sh")
