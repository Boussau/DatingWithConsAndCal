...
write.tree(tre[[1]], file = paste("completeTree_", as.character(i), ".dnd", sep=""))
if (extant$Nnode >=1) {
  print("EXTANT:")
  print(extant)
  write.tree(extant, file = paste("extantTree_", as.character(i), ".dnd", sep=""))
}
else {
...
#  print("EXTINCT: ")
#  print(extinct)
#  write.tree(extinct, file = paste("extinctTree_", as.character(i), ".dnd", sep=""))
#}
